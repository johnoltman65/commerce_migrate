...
@trigger_error('TaxType is deprecated in Commerce Migrate 8.x-2.0-beta4 and will be removed before Commerce Migrate 8.x-3.x. Use \Drupal\commerce_migrate_ubercart\Plugin\migrate\source\TaxTypeBase instead.', E_USER_DEPRECATED);
